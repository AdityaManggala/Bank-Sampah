                            ...
                            <tbody>
                                @foreach ($prices as $price)
                                    <tr class="odd gradeX">
                                        ...
                                        <td> <button class="btn btn-warning" data-toggle="modal" data-target="#editModal{{ $price->id }}"><i class="fas fa-edit"></i></button>

                                            <!-- Edit Modal-->
                                            <div class="modal fade" id="editModal{{ $price->id }}" tabindex="-1"
                                                role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content bg-warning">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Edit Jenis Harga : 
                                                                {{ $price->nama_jenis_harga }}</h5>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('admin.add.jenisharga') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col">
                            <label for="">Nama Jenis Harga:</label>
                            <input type="text" name="nama_jenis_harga" class="form-control" required>
                        </div>
                    </div>
            </div>
            <div class="modal-footer justify-content-between">
