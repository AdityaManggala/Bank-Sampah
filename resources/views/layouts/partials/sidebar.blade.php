        ...
        <nav class="mt-2">
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('jenis-harga-sampah.index') }}" class="nav-link @if (Route::is('jenis-harga-sampah.index'))
                                    active @endif">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('jenis-satuan-sampah.index') }}" class="nav-link @if (Route::is('jenis-satuan-sampah.index'))
                                    active
                                @endif">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Jenis Satuan</p>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('sampah.index') }}" class="nav-link @if (Route::is('sampah.index')) active
                    @endif">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Data Sampah</p>
                        </a>
